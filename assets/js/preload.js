export default function loadAnimation(){
    addEventListener('load',()=>{
        ...
        `;
        document.body.insertAdjacentHTML('afterbegin',preloadTemplate);
        ...
        setTimeout(()=>{
            $preload.classList.toggle('preload-hidden');
            setTimeout(()=>$preload.remove(),900);
        },4000);
    });
    //Animation Pizza Load - canvas
